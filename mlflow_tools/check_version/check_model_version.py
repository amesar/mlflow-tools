...
def check_version(model_name, version_or_stage, download_dir, report_file=None):
    ...
    comparison = _check_version(version, download_dir)
...
def main(model, version_or_stage, download_dir, report_file):
    ...
    for k,v in locals().items():
        print(f"  {k}: {v}")
    check_version(model, version_or_stage, download_dir, report_file)
