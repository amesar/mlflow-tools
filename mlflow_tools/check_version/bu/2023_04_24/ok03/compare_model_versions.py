...
def compare_versions(cfg, download_dir, compare_run_models, compare_reg_models, 
    ...
    vr1 = get_version(client1, cfg1["model"], cfg1["version_or_stage"])
    ...
    vr2 = get_version(client2, cfg2["model"], cfg2["version_or_stage"])
...
def get_version(client, model_name, version_or_stage):
    if isinstance(version_or_stage,int): # by version number
