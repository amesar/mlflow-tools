...
# MAGIC
# MAGIC Overview
# MAGIC * Dump registered model version and optionally its related objects
# MAGIC
# MAGIC Widgets
# MAGIC * `1. Model name` - registered model name
# MAGIC * `2. Version` - model version
# MAGIC * `3. Dump run` - dump version's run
# MAGIC * `4. Dump experiment` - dump run's experiment
# MAGIC * `5. Dump registered model` - dump version's registered model 
# MAGIC * `6. Dump permissions` - dump registered model's permissions
