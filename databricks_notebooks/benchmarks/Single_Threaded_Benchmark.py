...
# MAGIC %md ## Benchmark Model Serving Endpoint - Single Threaded
# MAGIC
...
dbutils.widgets.text("3. Output file base", "out")
output_file_base = dbutils.widgets.get("3. Output file base")

dbutils.widgets.text("4. Log modulo", "20")
log_mod = int(dbutils.widgets.get("4. Log modulo"))
                                       
dbutils.widgets.text("5 Client Request ID", "")
client_request_id = dbutils.widgets.get("5. Client Request ID")   

dbutils.widgets.text("6. Token", "")
token = dbutils.widgets.get("6. Token")
